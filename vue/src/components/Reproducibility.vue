<template>
  <div>
    ...
    <div class="documentation">
      <p>
        Число степеней свободы знаменателя критерия Кохрена - число степеней свободы суммы
        дисперсий по всех точкам спектра плана, т.е. - общее число точек спектра плана.
      </p>
      <p>
        Число степеней свободы - количество независимых наблюдений, по которым вычисляется
        данная оценка, минус число линейных связей между теми же наблюдаемыми значениями.
      </p>
      <p>
        Если воспроизводимость эксперимента подтвердилась, то значит каждая из построчных
        дисперсий оценивает одну и ту же величину - дисперсии воспроизводимости (
        дисперсии ошибки эксперимента ), которую можно оценить более точно путем
        усреднения построчных дисперсий
      </p>
      <p>
        Проверка воспроизводимости - проверка постоянства дисперсии шума. Считается, что
        условие постоянства дисперсии шума выполнено, если справедлива гипотеза:<br />
        "дисперсии в каждой точке факторного пространства оценивают одну и ту не
        величину”<br />
        Проверка этой гипотезы при альтернативной:<br />
        “хотя бы одна из построчных дисперсий не равна остальным"<br />
      </p>
      <p>
        производится с критерия Кохрена: если наблюдаемое значение критерия Кохрена меньше
        критического значения на выбранном значимости, то считается, что экспериментальные
        данные не опровергают гипотезу об однородности ряда дисперсий, тогда можно
        вычислить оценку дисперсии шума - дисперсии воспроизводимости, и продолжать
        обработку результатов эксперимента, который в данном случае является
        воспроизводимым.
      </p>
      <p>
